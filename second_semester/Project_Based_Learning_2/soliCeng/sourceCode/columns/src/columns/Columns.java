...
public class Columns {
	...
	void initialDisplay() {
		...
		if (language.equalsIgnoreCase(languages[1])) {
			...
			console.getTextWindow().setCursorPosition(130, 12);
			System.out.println("Puntaje : " + playerScore);
			console.getTextWindow().setCursorPosition(130,0);
		...
		console.getTextWindow().setCursorPosition(130, 20);System.out.println("Z: Select The Card");
		console.getTextWindow().setCursorPosition(130, 21);System.out.println("X: Release The Cards");
		console.getTextWindow().setCursorPosition(130, 22);System.out.println("C: Reset The Selection");
		console.getTextWindow().setCursorPosition(130, 23);System.out.println("V: Draw A Card");
